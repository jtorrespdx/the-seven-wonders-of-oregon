...
<div class="slider-item-title">Painted Hills</div>
...
<!--slider-item-->
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img2.png"/></div>
<div class="slider-item-title">Columbia River Gorge</div>
...
<!--slider-item-->
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img3.png"/></div>
<div class="slider-item-title">The Oregon Coast</div>
...
<!--slider-item-->
<div class="slider-item">
<div class="slider-item-image"><img src="<?php print base_path() . drupal_get_path('theme', 'corkedscrewer') ;?>/images/local/slider-img4.png"/></div>
<div class="slider-item-title">Smith Rock State Park</div>
<!-- <div class="slider-item-body">Monaco restaurants</div> -->
</div>
<!--EOF:slider-item-->
</div>
